  ...
  return (
    <div className="max-w-5xl mx-auto px-6 py-8">
      ...
      <div className="flex items-end justify-between gap-4 mb-4">
        <h1 className="display text-3xl">Data tamu &amp; pembayaran</h1>
        <Link href={`/book/rooms?${back}`} className="label hover:text-ink focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent">‹ Ganti kamar</Link>
      </div>
