...
export function StaySummary({ stay, adults, kids, channel, roomType, ratePerNight, rate, taxPercent }: {
  stay: Stay; adults: number; kids: number; channel: string; roomType?: string; ratePerNight?: number; rate?: RateBreakdown; taxPercent?: number;
}) {
